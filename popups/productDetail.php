<div id="productDetailPopup" class="new-category-popup-bg" onclick="togglePopup('productDetailPopup')" data-product-id="" data-category-id="">
    <div class="product-detail-container" onclick="doNotClose(event)">
        ...
        <div class="icon-container-edit-product">
            ...
            <img onclick="togglePopupEditProduct()" src="./assets/img/edit.png" class="edit-icon">
        </div>
